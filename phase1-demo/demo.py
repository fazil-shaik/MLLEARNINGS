...
client = QdrantClient(
    url="https://b11f6749-2431-4185-b1ec-2250d71d8dbe.sa-east-1-0.aws.cloud.qdrant.io",
    api_key=apiKey,
...
# def extract_data_and_upsert(pdf_path):
...
#     return f"{len(points)} chunks inserted."

# result = extract_data_and_upsert("./NIPS.pdf")
# print(result)
